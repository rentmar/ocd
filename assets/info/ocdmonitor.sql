...
CREATE TABLE usuario_noticia (idusuarionoticia INT(11) UNSIGNED NOT NULL AUTO_INCREMENT,
...
INSERT INTO tema (nombre_tema,rel_idcuestionario) VALUES ('Presentacion de Estatutos de organizaciones politicas',1),
									  ...
									  ('Difusion de encuestas',1),
									  ('Inhabilitacion de candidatos',1),
									  ('Computo departamental',1),
									  ('Padron Electoral',1),
									  ('Procedimientos Tecnico Electorales',1),
									  ('Financiamiento politico y partidario',1);
