		...
		<?php for($i=1; $i<5; $i++): ?>
			<div class="col-3 border">
				<div class="custom-control custom-radio custom-control-inline">
					<input type="radio" class="custom-control-input" id="pregunta<?php echo $idpregunta.'-m'.$i;?>s;" name="pregunta<?php echo $idpregunta.'-m'.$i;?>" value="si">
					<label class="custom-control-label" for="pregunta<?php echo $idpregunta.'-m'.$i;?>s;">si</label>
				</div>
				<div class="custom-control custom-radio custom-control-inline">
					<input type="radio" class="custom-control-input" id="pregunta<?php echo $idpregunta.'-m'.$i;?>n;" name="pregunta<?php echo $idpregunta.'-m'.$i;?>" value="no">
					<label class="custom-control-label" for="pregunta<?php echo $idpregunta.'-m'.$i;?>n;">no</label>
				</div>
			</div>
		<?php endfor; ?>
	</div>
