	...
	<div class="container">
		<div class="row">
			...
			<?php if($this->ion_auth->is_admin()): ?>
				<div class="col-sm-12 col-md-6 col-lg-3 col-xl-3">
					<div class="card">
						<div class="card-header" style="background-color:#7f182b;color:white">
							<h4>
								Administrar Control Social en la Jornada Censal
							</h4>
						</div>
						<img class="card-img-top" src="<?php echo base_url().'assets/img/Administrarnoticias.svg'; ?>" alt="Card image">
						<div class="card-body">
							<a href="<?php echo site_url('manejoDB/jornadaCensalAdministrador');?>" class="BOTON" role="button">
								Ir
							</a>
						</div>
					</div>
			...
			<div class="col-sm-12 col-md-6 col-lg-3 col-xl-3">
				<div class="card">
					<div class="card-header" style="background-color:#7f182b;color:white">
						<h4>Reporte Control Social Jornada Censal</h4>
					</div>
					<img class="card-img-top" src="<?php echo base_url().'assets/img/repcomp.svg'; ?>" alt="Card image">
					<div class="card-body">
						<a href="<?php echo site_url('controlCensal/reporteControlCensal');?>" class="BOTON" role="button">
							Ir
						</a>
					</div>
				</div>
