...
class Noticia extends CI_Controller
{
    ...
    public function IngresarDatosAtNoticia()
    {
        ...
        $DatosNoticia=[
            ...
            'rel_idsubtema'=>$this->input->post('tema')
            ];
...
//        $this->form_validation->set_rules('fechaP', 'FechaNoticia', 'required');
        ...
        else
        {
            ...
            $idnoticia=$this->Noticia_model->escribirFila($DatosNoticia);
       }
       $DatosNoticiaMedio=[
           'rel_idnoticia'=>$idnoticia,
           'rel_idmedio'=>$idmedio,
       ];
       var_dump($DatosNoticiaMedio);
       $idNoticiaMedio=$this->Noticia_model->escribirFila1($DatosNoticiaMedio);
    }
